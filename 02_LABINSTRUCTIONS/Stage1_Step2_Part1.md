...
- After the function is created, replace the function code with the code from [voting-app-store-vote.py](./Serverless-Voting-Application/01_LABSETUP/voting-app-store-vote.py)
